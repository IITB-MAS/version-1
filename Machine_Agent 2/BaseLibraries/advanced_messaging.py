...
def check_advanced_communications(message, timed_reply_queue, msg_to_send_queue, paths_dictionary,allotment_queue, parameters_queue):
    if message.protocol in ['contract_net_interaction_protocol',
        ...
        handle_all_proposals(all_proposals, msg_to_send_queue, paths_dictionary,allotment_queue,parameters_queue)
